...
SECRET_KEY = 'django-insecure-500q3=io2odu@l863i2@h!_^n5o$9e8e^^%6b^+hntq&)&pbwu'
...
INSTALLED_APPS = ["django.contrib.admin", "django.contrib.auth", "django.contrib.contenttypes", "django.contrib.sessions", "django.contrib.messages",
    "django.contrib.staticfiles", "rest_framework", "restaurant", "rest_framework.authtoken", "djoser", ]
...
DATABASES = {
    ...
    "default": {'ENGINE': 'django.db.backends.mysql', 'NAME': 'littlelemon', 'USER': 'root', 'PASSWORD': '', 'HOST': '127.0.0.1', 'PORT': '3306',
